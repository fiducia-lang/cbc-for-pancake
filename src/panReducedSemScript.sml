(*
  Semantics of panReducedLang
*)
Theory panReducedSem
Ancestors
  panReducedLang alignment[qualified] finite_map[qualified]
...
Definition evaluate_def:
  (evaluate (Skip:'a panReducedLang$prog,^s) = (NONE,s)) /\
...
Proof
  ...
  gvs[AllCaseEqs(), UNCURRY_eq_pair,
      ...
      lookup_kvar_def, oneline fix_clock_def,
